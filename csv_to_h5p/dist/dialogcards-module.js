...
exports.DialogCardsModule = void 0;
var run_content_module_1 = require("./run_content_module");
/**
 * This is the yargs module for dialogcards.
 */
var DialogCardsModule = /** @class */ (function () {
    function DialogCardsModule() {
        var _this = this;
        this.command = "dialogcards <input> <output>";
        this.describe = "Converts csv input to h5p dialog cards content. The headings for the columns \
        ...
        this.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, run_content_module_1.runDialogcards)(argv.input, argv.output, argv.n, argv.e, argv.d, argv.l, argv.m)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return DialogCardsModule;
}());
exports.DialogCardsModule = DialogCardsModule;
//# sourceMappingURL=dialogcards-module.js.map