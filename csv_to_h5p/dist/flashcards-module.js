 ...
 */
var FlashcardsModule = /** @class */ (function () {
    function FlashcardsModule() {
        var _this = this;
        this.command = "flashcards <input> <output>";
        this.describe = "Converts csv input to h5p flashcard content. The headings for the columns \
        ...
        this.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, run_content_module_1.runFlashcards)(argv.input, argv.output, argv.t, argv.e, argv.d, argv.l, argv.description)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
